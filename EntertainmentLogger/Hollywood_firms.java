...
public class Hollywood_firms extends JFrame {
    ...
    private static final String FILENAME = "Hollywood_firms_logs.txt";

    public Hollywood_firms () {
        setTitle("Hollywood Firms  Logger");
        setSize(700, 400);
