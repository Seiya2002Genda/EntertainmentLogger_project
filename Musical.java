...
public class Musical extends JFrame {
    ...
    private JTextField titleField, placeField, yearField, ratingField, commentField;
    private JButton addBtn, editBtn, deleteBtn, refreshBtn;

    private static final String FILENAME = "musical_logs.txt";

    public Musical() {
        setTitle("Musical Logger");
        setSize(700, 400);
        ...
        model = new DefaultTableModel(new Object[]{"Title Name", "Place", "Year", "Rating", "Comment"}, 0);
        ...
        addBtn.addActionListener(e -> {
            ...
            if (!title.isEmpty()) {
                model.addRow(new Object[]{title,place, year, rating, comment});
                clearFields();
                saveLogs(FILENAME);
            }
        });
        ...
        editBtn.addActionListener(e -> {
            ...
            if (selected >= 0) {
                ...
                model.setValueAt(placeField.getText(), selected, 1);
        ...
        table.getSelectionModel().addListSelectionListener(e -> {
            ...
            if (selected >= 0) {
                ...
                placeField.setText((String) model.getValueAt(selected, 1));
