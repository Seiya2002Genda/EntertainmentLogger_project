...
public class Opera extends JFrame {
    ...
    private JTextField titleField, composerField, ratingField, commentField;
    private JButton addBtn, editBtn, deleteBtn, refreshBtn;

    private static final String FILENAME = "opera_logs.txt";

    public Opera() {
        setTitle("Opera Logger");
        setSize(700, 400);
        ...
        inputPanel.add(new JLabel("Composer:"));
        ...
        model = new DefaultTableModel(new Object[]{"Title", "Composer", "Rating", "Comment"}, 0);
        ...
        addBtn.addActionListener(e -> {
            ...
            if (!title.isEmpty()) {
                model.addRow(new Object[]{title, composer, rating, comment});
                clearFields();
                saveLogs(FILENAME);
            }
        });
        ...
        editBtn.addActionListener(e -> {
            ...
            if (selected >= 0) {
                ...
                model.setValueAt(composerField.getText(), selected, 1);
        ...
        table.getSelectionModel().addListSelectionListener(e -> {
            ...
            if (selected >= 0) {
                ...
                composerField.setText((String) model.getValueAt(selected, 1));
